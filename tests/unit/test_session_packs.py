...
TOOL = "list_comments"
MODE_ENV = "KS4P_MODE"
POLICY_ENV = "KS4P_PACK_POLICY"
ENVS = (MODE_ENV, POLICY_ENV, "KS4P_ALL_TOOLS", "KS4P_LOCK_TOOLS")
QUIET = {"KS4P_UPDATE_CHECK": "off", "KS4P_STAR_NUDGE": "off"}
LITE_COUNT = 25
NO_CHANGE_PREFIX = packs.NO_CHANGE_PREFIX
FAMILY_SHA256 = {
...
def body():
    ...
    from kitchensink4ppt.ops import comments
