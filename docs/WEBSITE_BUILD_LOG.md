...
## 2026-09-14 00:43:41 KST - Installation typography and beginner setup
...
## 2026-09-14 01:38:14 KST - Desktop-first installation follow-up
...
## 2026-09-14 18:10:09 KST - Approved installation UX pass
Nyk approved implementation and review of the storefront plus all four product installation sections. Explicit themed download buttons; equal collapsed app paths; prerequisite-first complete steps; precise ChatGPT Desktop fields; OS/product-aware launcher and CLI commands; Copy buttons with contextual accessible names and honest failure feedback; preserved open section when switching languages; readable prose and consistent spacing; connected check and setup help. Storefront free-install navigation now Install, and Web clicking/writing wording clarified. All seven locales updated. Existing download assets/versions, product palettes and unrelated content preserved.

Validation:455 language/OS/viewport states in Chromium (7locales, five widths360/390/768/1366/1440, Windows plus supported Mac/Linux paths); copy bytes verified and clipboard-failure behavior checked; language disclosure state preserved; no page JS errors. Four version-pinned download HEAD requests200. Non-install section and asset-reference invariance checks passed except explicitly approved storefront Web text. Sol review findings repaired and re-reviewed (dynamic Copy labels, disclosure preservation). Narrow Spanish selector overflow found in expanded test and fixed. Exact evidence and generator: MCP Servers/Codex/scratch/install-ux-20260914. No clean desktop-app installation or OS runtime certification in this visual/copy pass. Claude frozen-candidate review pending; no deployment performed in this step.

## 2026-09-14 19:07:15 KST - C128 installation copy corrections
Formal German and Spanish address restored. Instructions now describe this single product rather than multiple selected products. Setup help uses the full corporate contact URL. Command-window instructions are explicit even when launcher setup is skipped; ChatGPT field-name variation is disclosed. No product runtime, bundle, payment or licensing files changed. The prior entry describes the combined five-page pass; storefront-specific edits apply only to that repository. Revised checks and candidate verification are recorded in MCP Servers/Codex/scratch/install-ux-20260914. No desktop app installation is certified by these web checks.
